...
export async function generateMetadata({ params }: { params: Params }) {
    ...
    try {
        ...
        console.error(`Error generating dynamic metadata for project: ${projectName}: `, error);
    ...
    try {
        ...
        return (
            <section className="pb-10">
                ...
                <main className="prose dark:prose-invert max-w-3xl">
                ...
                <div className="text-muted-foreground mt-10 flex items-center gap-1 text-sm font-medium">
                    <div className="hover:text-foreground mr-2 flex items-center gap-1 hover:transition">
